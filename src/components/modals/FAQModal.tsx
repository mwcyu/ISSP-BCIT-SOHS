      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200">
            <h2 className="text-2xl font-bold text-bcit-blue">Frequently Asked Questions</h2>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6">
            <div className="h-full flex items-center justify-center rounded-lg border border-gray-300 p-4 shadow-xl">
