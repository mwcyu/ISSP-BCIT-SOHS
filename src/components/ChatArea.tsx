      ...
      <div className="space-y-2">
        {suggestedPrompts.map((prompt, index) => (
          <button
            ...
            className="w-full text-left p-2 sm:p-3 bg-gray-50 hover:bg-gray-100 hover:border-[#003E6B] rounded-lg transition-all text-xs sm:text-sm md:text-base text-gray-700 border border-transparent focus:outline-none focus:ring-2 focus:ring-[#003E6B] focus:ring-offset-2"
          >
            {prompt}
          </button>
        ))}
