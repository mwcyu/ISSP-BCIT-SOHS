    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      {standards.map((standard, index) => (
        <div
          ...
          className="bg-gray-100 border border-gray-300 rounded-lg p-6 hover:shadow-md hover:border-bcit-blue transition-all cursor-pointer transform hover:scale-105"
        >
